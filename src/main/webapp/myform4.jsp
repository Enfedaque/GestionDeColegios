...
<html>
    ...
    <body>
        ...
        <form method="post" action="add-matricula">
            <div class="itemform">
            Year
            <input type="text" class="cuadroTexto" name="año_matricula" placeholder="Insert year"/><br/>
            </div>
            <div class="itemform">
            Duration
            <input type="text" class="cuadroTexto" name="duracion" placeholder="Insert duration"/><br/>
            </div>
